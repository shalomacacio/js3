...
<section class="content-header">
    ...
    <div class="container-fluid">
      <div class="row ">
        ...
        <div class="col-sm-10">
          <form class="form-inline"  action="{{ route('financeiro.cancelamentos') }}"   method="GET">
            @csrf
...
<section class="content">
    <div class="container-fluid">
        ...
        <center><h4> CANCELAMENTOS  </h4></center>
            ...
            <div class="col-12 table-responsive">
                <div class="col-12">
                    ...
                    <table id="example" class="table table-striped table-sm  display nowrap" style="width:100%">
                        ...
                        <tbody>
                          @foreach($cancelamentos as $can)
                          <tr>
                              <td>{{ $can->processo }}</td>
                              <td>{{ $can->codatendimento }}</td>
                              <td>{{ \Carbon\Carbon::parse($can->ate_abertura)->format('d-m-Y') }}</td>
                              <td>{{ \Carbon\Carbon::parse($can->ate_fechamento)->format('d-m-Y') }}</td>
                              <td>{{ $can->os }}</td>
                              <td>{{ $can->codos }}</td>
                              <td>{{ \Carbon\Carbon::parse($can->os_abertura)->format('d-m-Y') }}
                              <td>{{ \Carbon\Carbon::parse($can->os_fechamento)->format('d-m-Y') }}</td>
                              <td>{{ $can->encerrado }}</td>
                              <td>{{ $can->servico_prestado }}</td>
                          </tr>
                          @endforeach
                        </tbody>
                        <tfoot>
